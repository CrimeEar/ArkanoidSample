Shader "Custom/SoapBubble2DUnlit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 viewDir = normalize(float3(0, 0, 1)); // Fixed view direction for 2D
                ...
                float3 refractionDir = refract(-viewDir, normalMap, 1.0 / 1.33); // Assuming bubble material IOR = 1.33
                ...
                float intensity = dot(normalMap, viewDir);
                ...
                float edgeFactor = pow(saturate(1.0 - dot(viewDir, normalMap)), _OutlineThickness * 100.0);
